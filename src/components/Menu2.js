...
const Menu: FC < Props > = ({
    ...
    return ( <
        ...
        primaryText = {
            translate(`resources.invoices.name`, {
                smart_count: 2,
            })
        }
        leftIcon = {
        ...
        <SubMenu handleToggle = {() => handleToggle('menuCustomers')}
